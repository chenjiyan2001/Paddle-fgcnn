...
class DygraphModel():
    ...
    def create_model(self, config):
        ...
        sparse_feature_name = config.get("hyper_parameters.sparse_feature_name")
        sparse_feature_dim = config.get("hyper_parameters.sparse_feature_dim", 20)
        ...
        fgcnn_model = net.FGCNN(sparse_input_slot, sparse_feature_size,
                                sparse_feature_name, sparse_feature_dim,
    ...
    def create_feeds(self, batch_data, config):
        ...
        sparse_tensor = paddle.concat(sparse_tensor[:-1], axis=1)
        return label, sparse_tensor
